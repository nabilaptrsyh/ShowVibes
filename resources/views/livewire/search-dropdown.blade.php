<div class="relative mt-3 md:mt-0">
    <input wire:model.debounce.500ms="search" type="text" class="bg-gray-800 text-sm rounded-full w6-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-outline" placeholder="Cari">
