...
@section('content')
    <div class="film-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="/img/pertaruhan.jpg" alt="pertaruhan" class="md:w-96" style="width: 24rem">
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold">Pertaruhan (2022)</h2>
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    01-1.45-1.06l1-5.63-4.12-4a1 1 0 01-.25-1 1 1 01.81-.68l5.7-.83 2.51-5.13a1 1
                    ...
                    <span>Maret 20, 2022 </span>
                    <span class="mx-2">|</span>
                    <span>Aksi, Drama</span>
                </div>

                <p class="text-gray-300 mt-8">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam recusandae soluta quam.
                    Sunt eius, quibusdam doloribus, maiores impedit placeat illum odit dolorum minus excepturi 
                    maxime accusamus ut enim autem laborum, tenetur voluptatem nulla alias optio libero voluptate
                    laboriosam eos cumque repellendus. Voluptate illum qui repudiandae nihil officia dignissimos praesentium magnam.
                </p>

                <div class="mt-12">
                    <h4 class="text-white font-semibold">Pemeran Unggulan</h4>
                    <div class="flex mt-4">
                        <div>
                            <div>Jefri Nichol</div>
                            <div class="text-sm text-gray-400">Vidio.com</div>
                        </div>
                        <div class="ml-8"> 
                            <div>Jefri Nichol</div>
                            <div class="text-sm text-gray-400">Vidio.com</div>
                ...
                <div class="mt-12">
                    <button class="flex items-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150">
                        <svg class="w-6 fill-current" viewBox="0 0 24 24"><path d="MO 0h24v24H0z" fill="none
                            ...
                            <span class="ml-2">Mulai Trailer</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="pemeran-film border-b border-gray-800">
