...
@section('content')
    <div class="film-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$movie['poster_path'] }}" alt="pertaruhan" class="md:w-96" style="width: 24rem">
            <div class="md:ml-24">
                ...
                <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                    <div class="bg-gray-900 rounded">
                        ...
                        <div class="modal-body px-8 py-8">
                            ...
                            src="https://www.youtube.com/embed/{{ $movie['videos']['results'][0]['key'] }}" style="border:0;" allow="autoplay; encrypted-media"
    ...
    <div class="gambar-film" x-data="{ isOpen: false, image: '' }">
        <div class="container mx-auto px-4 py-16">
