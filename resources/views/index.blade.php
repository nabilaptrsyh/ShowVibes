    ...
    <div class="container mx-auto px-4 pt-16">
        <div class="film-populer">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                <div class="mt-8">
                    <a href="#">
                        <img src="img/pertaruhan.jpg" alt="pertaruhan">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray:300">Pertaruhan</a>
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="img/godzilla.jpg" alt="godzilla">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray:300">Godzilla</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            <svg class="fill-current text-orange-500 w-4" viewBox="0 0 24 24"><g data-name="
                            Layer 2"><path d="M17.56 21a1 1 0 01-.46-.11L12 18.22l-5.1 2.67a1 1 0
                            01-1.45-1.06l1-5.63-4.12-4a1 1 0 01-.25-1 1 1 01.81-.68l5.7-.83 2.51-5.13a1 1
